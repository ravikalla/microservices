...
import { SavingsaccountComponent } from 'app/entities/savingsaccount/savingsaccount/savingsaccount.component';
...
describe('Component Tests', () => {
    describe('Savingsaccount Management Component', () => {
        let comp: SavingsaccountComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SavingsaccountComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.savingsaccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
