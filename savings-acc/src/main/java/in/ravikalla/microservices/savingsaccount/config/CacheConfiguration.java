...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("savingsaccount");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("savingsaccount");
        ...
        config.getMapConfigs().put("in.ravikalla.microservices.savingsaccount.domain.*", initializeDomainMapConfig(jHipsterProperties));
